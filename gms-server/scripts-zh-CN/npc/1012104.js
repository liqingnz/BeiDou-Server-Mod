    ...
    if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                ...
                cm.sendYesNo("如果您使用REG优惠券，您的发型将随机改变，并有机会获得一种新的实验风格，甚至您自己都认为不可能。您要使用#b#t5159001##k来真正改变您的发型吗？");
            } else if (selection == 1) {
                beauty = 1;
                hairnew = Array();
                if (cm.getPlayer().getGender() == 0) {
                ...
                cm.sendYesNo("如果你使用了经验值券，你的发型将会随机改变，并有机会获得一种你自己都没想到可能存在的新实验性发型。你要使用 #b#t5159001##k 真的改变你的发型吗？");
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
