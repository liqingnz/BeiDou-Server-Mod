...
function start() {
    cm.sendSimple("我是助手Rinz。你有#b#t5154000##k、#b#t5159001##k或#b#t5159005##k吗？如果有的话，你觉得让我来给你打理发型怎么样？你想怎么处理你的头发呢？\r\n#L0#理发：#i5154000##t5154000##l\r\n#L1#理发（基础样式）：#i5159001##t5159001##l\r\n#L2#理发（实验样式）：#i5159001##t5159001##l\r\n#L3#染发：#i5159005##t5159005##l");
}
    ...
    if (mode < 1) {
        ...
        if (status == 1) {
            if (selection == 0) {
                ...
                cm.sendYesNo("如果你使用REG优惠券，你的发型将会随机改变。你要使用#b#t5159001##k并真的改变你的发型吗？");
            } else if (selection == 2) {
                beauty = 1;
                hairnew = Array();
                if (cm.getPlayer().getGender() == 0) {
                ...
                cm.sendYesNo("如果你使用普通的优惠券，你的发色将会随机改变。你还想使用 #b#t5159005##k 来改变吗？");
            }
        } else if (status == 2) {
            cm.dispose();
            if (beauty == 1) {
