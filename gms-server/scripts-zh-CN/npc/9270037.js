...
function start() {
    cm.sendSimple("嗨，我是这里的助手。别担心，我完全有能力做到这一点。如果你碰巧有#b#t5159001##k或#b#t5159005##k，那就让我来处理剩下的事情吧？\r\n#L1#理发：#i5159001##t5159001##l\r\n#L2#染发：#i5159005##t5159005##l");
}
...
function action(mode, type, selection) {
    if (mode < 1) {
        ...
        if (selection == 1) {
            ...
            cm.sendYesNo("如果您使用REG优惠券，您的发型将随机改变，并有机会获得我设计的新实验发型。您要使用#b#t5159001##k来真正改变您的发型吗？");
        } else if (selection == 2) {
            beauty = 2;
            haircolor = Array();
            ...
            cm.sendYesNo("如果您使用REG优惠券，您的发型将会随机改变。您还想使用#b#t5159005##k并改变它吗？");
        } else if (status == 2) {
            if (beauty == 1) {
