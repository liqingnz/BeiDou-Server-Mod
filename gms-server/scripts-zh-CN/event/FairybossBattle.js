...
var entryMap = 300030310;    // 战斗地图
var exitMap = 300030300;     // 退出后返回地图
var recruitMap = 300030300;  // 远征队招募地图（NPC所在）
var clearMap = 300030300;     // 通关后返回地图
...
function setup(level, lobbyid) {
    ...
    eim.getInstanceMap(300030310).resetPQ(level);
