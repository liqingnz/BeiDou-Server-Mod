...
var minLevel = 80, maxLevel = 200;
var entryMap = 541020800;    // 战斗地图
var exitMap = 541020700;     // 退出后返回地图
var recruitMap = 541020700;  // 远征队招募地图（NPC所在）
var clearMap = 541020700;     // 通关后返回地图
...
function setup(level, lobbyid) {
    ...
    eim.getInstanceMap(541020800).resetPQ(level);
