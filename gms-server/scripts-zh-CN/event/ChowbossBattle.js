...
var minLevel = 95, maxLevel = 200;
var entryMap = 300010420;    // 战斗地图
var exitMap = 300010410;     // 退出后返回地图
var recruitMap = 300010410;  // 远征队招募地图（NPC所在）
var clearMap = 300010410;     // 通关后返回地图
...
function setup(level, lobbyid) {
    ...
    eim.getInstanceMap(300010420).resetPQ(level);
