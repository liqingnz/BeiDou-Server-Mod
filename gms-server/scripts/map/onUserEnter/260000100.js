/*
    Departure countdown for the Ariant station platform -- shown the moment a player walks in.
    ...
    The clock reads the "nextTakeoff" timestamp that event/Genie.js publishes in scheduleNew()
