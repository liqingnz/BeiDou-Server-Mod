/*
    Departure countdown for the Orbis dock (to Ellinia) -- shown the moment a player walks in.
    ...
    The clock reads the "nextTakeoff" timestamp that event/Boats.js publishes in scheduleNew()
