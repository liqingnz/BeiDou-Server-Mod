/*
    Departure countdown for the Changi Airport -- shown the moment a player walks in.
    ...
    The clock reads the "nextTakeoff" timestamp that event/AirPlane.js publishes in scheduleNew()
