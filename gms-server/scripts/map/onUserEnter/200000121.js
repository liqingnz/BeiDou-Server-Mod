/*
    Departure countdown for the Orbis dock (to Ludibrium) -- shown the moment a player walks in.
    ...
    The clock reads the "nextTakeoff" timestamp that event/Trains.js publishes in scheduleNew()
