...
function start() {
    ...
    cm.sendNextSelectLevel("Goto", "Where would you like to go?\r\n" + text);
}
...
function buildSections() {
    var sections = [{ title: "#rTowns:#k", registry: GameConstants.GOTO_TOWNS }];
    if (cm.getPlayer().isGM()) {
        sections.push({ title: "#rAreas:#k", registry: GameConstants.GOTO_AREAS });
    }
    return sections;
}
