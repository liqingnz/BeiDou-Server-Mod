...
var cost;
var qty = 1;
var matList = [3100000, 3100001, 4001126, 3101001]; // 4900000 六一铅笔，
var mapleLeafId = 4001126;
// [2340000, 15], [2049100, 15],  white/chaos
// 100% scrolls: [2043003, 240], [2044003, 240], [2044303, 240], [2044403, 240], [2044503, 240], [2044603, 240], [2043303, 240], [2044703, 240], [2044890, 240], [2044990, 240], 
var bossPointRewardPool = [[2340000, 40], [2049100, 40], [2022179, 4], [2022282, 10], [2040915, 15], [2040920, 15], [3010121, 6666]];
var pqPointRewardPool = [[4031062, 30], [3010083, 40], [2044025, 40], [2043023, 40], [2044417, 40], [2044317, 40], [2044612, 40], [2044512, 40], [2043812, 40], [2043712, 40], [2044712, 40], [2043312, 40], [2044908, 40], [2044815, 40], [2040915, 15], [2040920, 15], [3010121, 6666]];
// [1022089, 8], [1012186, 8], [1122018, 8], 

// 新年
// var eventRewardPool = [[1072427, 1000], [1122018, 200], [1022089, 1000]];
// 周年
var eventRewardPool = [[1102166, 200], [1112413, 200], [1072427, 1000], [5010009, 400], [3010135, 400]];
// 六一
// var eventRewardPool = [[1012181, 100], [1012182, 150], [1012183, 200], [1122018, 200], [1112407, 200], [1112408, 200], [1132013, 1000], [3010059, 1000], [3010018, 1000]];
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (selection == 0) {
            ...
            var options = ["战士", "法师", "飞侠", "射手", "海盗"/*,"#t4032496#"*/];
...
function tradePoints(itemId, rewardPool, selection) {
    ...
    if (!cm.haveItem(itemId, rewardPool[selection][1]))
        cm.sendOk("你没有足够的#b#t" + itemId + "#");
    else {
        if (cm.canHold(rewardPool[selection][0], 1)) {
